  ...
  return (
    ...
    <div id ="dialogoverlay"></div>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Button  onClick={login}  type="submit" style = {{marginLeft: "4px"}} disabled={!validateForm()}>
          Login
        </Button>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Button onClick={register}  id="signupfoot" style = {{marginLeft: "4px"}} type="submit" disabled={!validateForm()}>
          Sign Up!
        </Button>
